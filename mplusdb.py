...
class MplusDatabase(object):
    ...
    __table_fields = {  # these are used to formulate batch inserts queries
        ...
        'run': [
            'id', 'dungeon', 'level', 'period', 'timestamp', 'duration',
            'faction', 'region'
        ],
        'roster': ['run_id', 'character_id', 'name', 'spec', 'realm'],
        'run_composition': [
            'run_id', 'mage_arcane', 'mage_fire', 'mage_frost', 'paladin_holy',
            'paladin_protection', 'paladin_retribution', 'warrior_arms',
            'warrior_fury', 'warrior_protection', 'druid_balance',
            'druid_feral', 'druid_guardian', 'druid_restoration',
